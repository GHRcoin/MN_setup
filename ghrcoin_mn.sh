...
COIN_BOOTSTRAP='https://github.com/GHRcoin/GHRCoin/releases/download/v1.0.0.0/bootstrap.zip'
...
function download_node() {
  ...
  wget -q $COIN_TGZ
  tar xzvf GHRCoin-1.0.0.0-daemon-ubuntu_16.04.tar.gz
  cd rev >/dev/null 2>&1
...
function important_information() {
 ...
 echo -e "${GREEN}ghrcoin-cli masternode status${NC}"
 echo -e "${GREEN}ghrcoin-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
